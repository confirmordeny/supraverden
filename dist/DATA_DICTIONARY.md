...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Country | Country | text | 2 | mandatory | Country code for the organisation. EU is used for European Union entities and ZZ is used for all other international organisations. |  |  | EU, ZZ |
