...
| Country | Country code | text | 2 | mandatory | Country code for the organisation. EU is used for European Union entities and ZZ is used for all other international organisations. | EU, ZZ |  | EU, ZZ |
| OpenSanctions_id | OpenSanctions_id | OpenSanctions ID | 50 | mandatory | OpenSanctions ID code from opensanctions.org |  | no spaces | bic-ESMAFRP2, NK-Ubo23KznV2pvcXMiQkTmvd |
