...
* Arab League entities (15 entities)
...
* Central American Integration System entities (4 entities)
* CGIAR entities (9 entities)
...
* ECOWAS entities (5 entities)
* EFTA entities (3 entities)
* EU institutions and bodies (78 entities)
...
* Organization of Turkic States entities (4 entities)
