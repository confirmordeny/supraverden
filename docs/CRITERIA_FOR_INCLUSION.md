# Introduction
The aim of this repo is to create a list of international organisations. For this purpose, we will define an international organisation as a legal person created by legal agreements between countries. To be clear, this should not cover organisations that operate in multiple countries but that are created under and subject to the national law (domestic law) of one country. If, however, an organisation is created under the laws of one country but is recognised as an international organisation in its home country by being afforded special immunities and privileges then it can be included.
